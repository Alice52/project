  ...
  methods: {
    ...
    batchDeleteRelation(val) {
      ...
      this.$http({
        url: this.$http.adornUrl(
          "/product/attr-attrgroup-relations-by-attrIds"
        ),
        method: "delete",
    ...
    submitAddRealtion() {
      ...
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          url: this.$http.adornUrl(
            "/product/attr-attrgroup-relations/" + this.attrGroupId
          ),
          method: "put",
    ...
    init(id) {
      ...
      this.$http({
        url: this.$http.adornUrl(
          `/product/attrgroup-attrs/${this.attrGroupId}`
        ),
        method: "get",
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl(
          `/product/${this.attrGroupId}/no-relation/attrs`
        ),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
