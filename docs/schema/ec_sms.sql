...
Source Database       : ec_sms

Target Server Type    : MYSQL
Target Server Version : 50731
File Encoding         : 65001

Date: 2020-10-06 13:01:31
*/
...
CREATE TABLE `sms_coupon_history` (
  ...
  `is_deleted` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='优惠券领取历史记录';

-- ----------------------------
-- Records of sms_coupon_history
-- ----------------------------
INSERT INTO `sms_coupon_history` VALUES ('1', '0', '0', 'string', '0', '2020-10-06 03:45:51', '0', '2020-10-06 03:45:51', '0', '0', '2020-10-06 03:45:51', '2020-10-06 11:46:11', '1');
